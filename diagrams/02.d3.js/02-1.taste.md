...
기본 뼈대가 되는 index.html은 요로코롬 생겼다. 여기서 d3js.org가 가지고 있는 d3.v4.min.js 자바스크립트 파일을 로드하고, 아래에 쓸 index.js 자바스크립트 파일을 로드하는 것으로 기본 틀은 완성된다.
